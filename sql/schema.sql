...
CREATE TABLE IF NOT EXISTS `activity_product` (
  ...
  `enable_group_buy` TINYINT UNSIGNED NOT NULL DEFAULT 0,
  `enable_bargain` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '1=砍价商品，与拼团互斥',
  `bargain_floor_price` DECIMAL(10,2) NULL DEFAULT NULL COMMENT '砍价底价',
  `bargain_duration_hours` INT UNSIGNED NOT NULL DEFAULT 24,
  `bargain_new_user_hours` INT UNSIGNED NOT NULL DEFAULT 48,
  `bargain_help_daily_max` INT UNSIGNED NOT NULL DEFAULT 20,
  `enable_bargain_self_cut` TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '1=允许发起人自砍',
  `bargain_self_cut_mode` TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '1=随机区间 2=固定金额',
  `bargain_self_cut_min` DECIMAL(10,2) NOT NULL DEFAULT 0.10,
  `bargain_self_cut_max` DECIMAL(10,2) NOT NULL DEFAULT 1.00,
  `bargain_new_cut_mode` TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '1=随机区间 2=固定金额',
  `bargain_new_min` DECIMAL(10,2) NOT NULL DEFAULT 1.00,
  `bargain_new_max` DECIMAL(10,2) NOT NULL DEFAULT 5.00,
  `bargain_old_cut_mode` TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '1=随机区间 2=固定金额',
  `bargain_old_min` DECIMAL(10,2) NOT NULL DEFAULT 0.10,
  `bargain_old_max` DECIMAL(10,2) NOT NULL DEFAULT 1.00,
  `group_buy_price` DECIMAL(10,2) NULL DEFAULT NULL,
  `group_buy_target_count` INT UNSIGNED NULL DEFAULT NULL,
...
-- -----------------------------------------------------------------------------
-- bargain 砍一刀会话（与 migrations/2026-08-19-bargain.sql 对齐）
-- -----------------------------------------------------------------------------
